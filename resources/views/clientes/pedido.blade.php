...
@section('contenidoPrincipal')
    <div class="pedido">
        <div class="items">
            ...
            @foreach ($itemsPedido as $item)
                <article class="item">
                    ...
                    <div>
                        <div class="precio">{{ __('content.currency').' '.$item->producto($item)->precioDescuento($item->producto_id) }}</div>
        ...
        <div class="resumen">
            ...
            {{-- <button class="pagar" type="button" data-toggle="modal" data-target="#exampleModalCenter">{{ __('content.pay') }}</button> --}}
