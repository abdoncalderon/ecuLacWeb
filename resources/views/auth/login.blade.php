...
@section('section')
    ...
    <div class="auth">
        ...
        <div class="ventana">
            ...
            <div class="titulo">{{ __('content.login') }}</div>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group row mb-0">
                        <div class="col-md-8 offset-md-4">
                            <button type="submit" class="btn btn-primary btn-lg">{{ __('content.login') }}</button>

                            @if (Route::has('password.request'))
                                <a class="btn btn-link btn-md" href="{{ route('password.request') }}">{{ __('messages.forgotpassword') }}</a>
                            @endif
                        </div>
                    </div>
